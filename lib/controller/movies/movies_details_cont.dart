...
class MoviesDetailsControllerImp extends MoviesDetailsController {
  ...
  addFav(movieId) async {
    try {
      ...
      var url = "${user.serverInfo!.serverUrl}/player_api.php?password=${user.userInfo!.password}&username=${user.userInfo!.username}&action=get_vod_info&vod_id=$movieId";
      ...
      var caturl = "${user.serverInfo!.serverUrl}/player_api.php?password=${user.userInfo!.password}&username=${user.userInfo!.username}&action=get_vod_streams&category_id=$catId";
  ...
  getAuthLink() async {
    ...
    if(user != null){
      final link =
          "${user.serverInfo!.serverUrl}/movie/${user.userInfo!.username}/${user.userInfo!.password}/";
      return link;
    } else {
      Get.defaultDialog(title: "Error", middleText: "Server Error!!");
      return;
