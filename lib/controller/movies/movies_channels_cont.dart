...
class MovieChannelsControllerImp extends MovieChannelsController {
  ...
  getMoviesCount(catId) async {
    ...
    var url = "${user.serverInfo!.serverUrl}/player_api.php?password=${user.userInfo!.password}&username=${user.userInfo!.username}&action=get_vod_streams&category_id=$catId";
