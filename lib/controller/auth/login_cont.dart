...
import 'package:primpiptv/core/functions/handling_data.dart';
import 'package:primpiptv/data/source/remote/login.dart';
  ...
  loginUser() async {
    ...
    if (formdata!.validate()) {
      ...
      if(StatusRequest.success == statusRequest){
        ...
        var fetchServer = await callServer.fetchServer(server_domain, server_port, username.text, password.text);
